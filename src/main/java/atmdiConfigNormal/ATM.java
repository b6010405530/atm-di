package atmdiConfigNormal;

import java.io.IOException;

/**
 * An atmdiConfigNormal.ATM that accesses a bank.
 */
public class ATM {
	...
	/**
     * Constructs an atmdiConfigNormal.ATM for a bank.
	 */
	...
	/**
     * Resets the atmdiConfigNormal.ATM to the initial state.
	 */
	public void reset() {
		customerNumber = -1;
		currentAccount = null;
	...
	/**
     * Gets the current state of this atmdiConfigNormal.ATM.
